...
terraform {
  ...
  backend "gcs" {
    ...
    prefix = "alexistudies-dev-firebase"
  }
}
...
module "project" {
  ...
  name                    = "alexistudies-dev-firebase"
  org_id                  = ""
...
module "alexistudies_dev_mystudies_firestore_raw_data" {
  source  = "terraform-google-modules/cloud-storage/google//modules/simple_bucket"
  version = "~> 1.4"

  name       = "alexistudies-dev-mystudies-firestore-raw-data"
  project_id = module.project.project_id
  location   = "us-east1"
