...
module "project" {
  ...
  shared_vpc_subnets = [
    "projects/alexistudies-dev-networks/regions/us-east1/subnetworks/alexistudies-dev-gke-subnet",
  ]
  activate_apis = [
...
module "alexistudies_dev" {
  source  = "terraform-google-modules/cloud-dns/google"
  version = "~> 3.0.0"

  name       = "alexistudies-dev"
  project_id = module.project.project_id
  domain     = "alexistudies-dev.clinicalstudies.one."
  type       = "public"
...
module "alexistudies_dev_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "alexistudies-dev-gke-cluster"
  project_id         = module.project.project_id
  region             = "us-east1"
  regional           = true
  network_project_id = "alexistudies-dev-networks"

  network                 = "alexistudies-dev-network"
  subnetwork              = "alexistudies-dev-gke-subnet"
  ip_range_pods           = "alexistudies-dev-pods-range"
  ip_range_services       = "alexistudies-dev-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@alexistudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@alexistudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@alexistudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@alexistudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@alexistudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@alexistudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@alexistudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@alexistudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@alexistudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@alexistudies-dev-apps.iam.gserviceaccount.com",
    ],
  }
}
